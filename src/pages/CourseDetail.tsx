    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          {nextModule && (
            <Button asChild size="sm" className="mt-4 rounded-pill bg-accent hover:bg-accent/90 text-accent-foreground">
            ...
            {modules.map((m: any, i: number) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-4 rounded-xl border border-border bg-card p-4 transition-all hover:border-primary/30 ${isCompleted ? 'opacity-80' : ''}`}
                >
