    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-lg">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
          ...
          <div>
            <Label className="flex items-center gap-1"><Lock className="h-3 w-3" /> Email Address</Label>
            <Input value={profile?.email || ''} disabled className="mt-1 rounded-lg opacity-60" />
            <p className="mt-1 text-xs text-muted-foreground">Cannot be changed. Contact support if needed.</p>
          </div>
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">Permanently linked to your account.</p>
          </div>
          <Button onClick={handleSave} disabled={saving} className="rounded-pill bg-primary hover:bg-primary/90">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
          ...
          <Button onClick={handlePasswordChange} disabled={changingPw} variant="outline" className="rounded-pill">
        ...
        <div className="text-xs text-muted-foreground">
          ...
          {profile?.is_enrolled && <span className="ml-2 rounded-pill bg-primary/10 px-2 py-0.5 text-primary">Enrolled</span>}
        </div>
      </div>
    </DashboardLayout>
  );
